...
\begin{figure}
\includegraphics[width=3.62in]{/home/giorgia/Documents/frontera-final/modelodis} \caption{Modelo propuesto donde el ser humano es un cuarto factor determinante en la distribución de especies. Modificado de Anderson (2013).}\label{fig:unnamed-chunk-1}
\end{figure}
